...
<div class="tt-result-details">\
  ...
  <div class="tt-detail-card"><div class="tt-detail-label">Estimated Height</div><div class="tt-detail-value">' + (r.estimatedHeightFt || '?') + ' ft</div><div class="tt-detail-sub">' + esc(r.heightTier || '') + ' tree classification</div>' + (r.heightConfidence === 'low' ? '<div class="tt-detail-sub" style="margin-top:4px;color:var(--orange);font-style:italic;">Limited reference objects — on-site measurement recommended</div>' : '') + '</div>\
